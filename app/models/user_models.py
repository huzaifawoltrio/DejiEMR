...
class User(db.Model):
    ...
    # Add a one-to-one relationship to the DoctorProfile model
...
class DoctorProfile(db.Model):
    ...
    # Encrypted PII and sensitive fields (using String(255) or Text for length)
    ...
    # Unencrypted fields for filtering or direct display
